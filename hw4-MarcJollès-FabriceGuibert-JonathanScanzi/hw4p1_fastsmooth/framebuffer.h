...
class FrameBuffer {
    ...
    private:
        ...
        GLuint color_texture_id_, pass_texture_;

    public:


        // Simple function to initialize and bind textures, to avoid repetition and clarify code
        void initializeTexture(GLuint* tex_id, bool use_interpolation){
        ...
        std::tuple<int,int> Init(int image_width, int image_height, bool use_interpolation = false) {
            ...
            initializeTexture(&color_texture_id_, use_interpolation);

            // create temp texture
            initializeTexture(&pass_texture_, use_interpolation);
            ...
            return std::make_tuple(color_texture_id_, pass_texture_);
        }

        void Cleanup() {
            glDeleteTextures(1, &color_texture_id_);
            glDeleteTextures(1, &pass_texture_);
